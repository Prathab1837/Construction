...
function Basic() {
  return (
    <>
        <div data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBackdrop" aria-controls="offcanvasWithBackdrop">
            <div style={{backgroundColor:'rgba(229, 194, 65, 0.949)',color:'black', cursor:'pointer', border:'3px solid azure'}} className='p-4 rounded text-center'>
                <h2>Basic Package</h2>
                <span> <span className='fw-bold fs-3'>₹ 1999</span> <span>per sqft</span> </span>
            </div>
        </div>

        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
        <div style={{backgroundColor:'rgba(229, 194, 65, 0.949)'}} class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasWithBackdropLabel">Basic Package</h5>
